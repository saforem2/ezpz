...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The name of the wandb project to use.",
    )
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        rdk = getattr(raw_datasets, "keys", lambda: raw_datasets.keys())
        if "validation" not in rdk():
    ...
    if args.with_tracking:
        ...
        if (
            ...
            # except Exception:
            #     ezpz.breakpoint(0)
        accelerator.init_trackers(wbproj_name, experiment_config)
